...
<html lang="en">
  ...
  <div class="container">
    <div class="container-inner">
      <img class="img-circle media-object" src="../../images/da-vinci/leonardo-da-vinci.jpg">
      <h3 class="profile-header-user">Leonardo da Vinci</h3>
...
<p class="lead"><a href="../artists.php"><span style="float: left;"><< Back to Artists List</span></a><a href="michelangelo.php"><span style="float:right;">Next Artist >></span></p></a>

<div class="container m-y-md" data-grid="images">
  <div>
    <img data-width="640" data-height="400" data-action="zoom" src="../../images/da-vinci/ultima-cena.jpg">
  </div>

  <div>
    <img data-width="640" data-height="640" data-action="zoom" src="../../images/da-vinci/mona-lisa.jpg">
  </div>

  <div>
    <img data-width="640" data-height="640" data-action="zoom" src="../../images/da-vinci/saint-john-the-baptist.jpg">
  </div>
<!--
  <div>
    <img data-width="640" data-height="640" data-action="zoom" src="../../images/da-vinci/.jpg">
  </div>
  ...
  <div>
    <img data-width="640" data-height="400" data-action="zoom" src="../../images/da-vinci/.jpg">
  </div>
