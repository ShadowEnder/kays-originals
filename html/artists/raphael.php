...
<html lang="en">
  ...
  <div class="container">
    <div class="container-inner">
      <img class="img-circle media-object" src="../../images/raphael/raphael.jpg">
      <h3 class="profile-header-user">Raphael</h3>
      <p class="profile-header-bio">
         Italian painter and architect of the High Renaissance. His work is admired for its clarity of form, ease of composition, and visual achievement of the Neoplatonic ideal of human grandeur.
      </p>
    </div>
  </div>
...
<p class="lead"><a href="vasari.php"><span style="float: left;"><< Previous Artist</span></a><a href="dave-gamache.php"><span style="float:right;">Next Artist >></span></p></a>

<div class="container m-y-md" data-grid="images">
  <div>
    <img data-width="640" data-height="400" data-action="zoom" src="../../images/raphael/sistine-madonna.jpg">
  </div>

  <div>
    <img data-width="640" data-height="640" data-action="zoom" src="../../images/raphael/galatea.jpg">
  </div>

  <div>
    <img data-width="640" data-height="640" data-action="zoom" src="../../images/raphael/the-mond-crucifixion.jpg">
  </div>
<!--
  <div>
    <img data-width="640" data-height="640" data-action="zoom" src="../../images/raphael/.jpg">
  </div>
  ...
  <div>
    <img data-width="640" data-height="400" data-action="zoom" src="../../images/raphael/.jpg">
  </div>
