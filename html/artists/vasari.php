...
<html lang="en">
  ...
  <div class="container">
    <div class="container-inner">
      <img class="img-circle media-object" src="../../images/giorgio-vasari/giorgio-vasari.jpg">
      <h3 class="profile-header-user">Giorgio Vasari</h3>
      <p class="profile-header-bio">
        Italian painter, architect, writer, and historian, most famous today for his Lives of the Most Excellent Painters, Sculptors, and Architects, considered the ideological foundation of art-historical writing.
      </p>
    </div>
  </div>
...
<p class="lead"><a href="sandro-botticelli.php"><span style="float: left;"><< Previous Artist</span></a><a href="raphael.php"><span style="float:right;">Next Artist >></span></p></a>

<div class="container m-y-md" data-grid="images">
  <div>
    <img data-width="640" data-height="400" data-action="zoom" src="../../images/giorgio-vasari/the-deposition.jpg">
  </div>

  <div>
    <img data-width="640" data-height="640" data-action="zoom" src="../../images/giorgio-vasari/the-nativity-with-the-adoration-of-the-shepherds.jpg">
  </div>

  <div>
    <img data-width="640" data-height="640" data-action="zoom" src="../../images/giorgio-vasari/temptation-of-saint-jerome.jpg">
  </div>
<!--
  <div>
    <img data-width="640" data-height="640" data-action="zoom" src="../../images/giorgio-vasari/.jpg">
  </div>
  ...
  <div>
    <img data-width="640" data-height="400" data-action="zoom" src="../../images/giorgio-vasari/.jpg">
  </div>
