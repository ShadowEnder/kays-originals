...
<html lang="en">
  ...
  <div class="container">
    <div class="container-inner">
      <img class="img-circle media-object" src="../../images/titian/tizian.jpg">
      <h3 class="profile-header-user">Titian</h3>
      <p class="profile-header-bio">
         One of the most versatile of Italian painters, equally adept with portraits, landscape backgrounds, and mythological and religious subjects.
      </p>
    </div>
  </div>
...
<p class="lead"><a href="michelangelo.php"><span style="float: left;"><< Previous</span></a><a href="sandro-botticelli.php"><span style="float:right;">Next Artist >></span></p></a>

<div class="container m-y-md" data-grid="images">
  <div>
    <img data-width="640" data-height="400" data-action="zoom" src="../../images/titian/sacred-and-profane-love.jpg">
  </div>

  <div>
    <img data-width="640" data-height="640" data-action="zoom" src="../../images/titian/bacchus-and-ariadne.jpg">
  </div>

  <div>
    <img data-width="640" data-height="640" data-action="zoom" src="../../images/titian/the-abduction-of-europa.jpg">
  </div>
<!--
  <div>
    <img data-width="640" data-height="640" data-action="zoom" src="../../titian/da-vinci/.jpg">
  </div>
  ...
  <div>
    <img data-width="640" data-height="400" data-action="zoom" src="../../titian/da-vinci/.jpg">
  </div>
