...
<html lang="en">
  ...
  <body>
    ...
    <main role="main" class="container">
      ...
      <h1 class="mt-5" style="text-align: center">Upcoming Events</h1>
      <p class="lead" style="text-align: center">Hosted by Kay's Originals</p>
      <br />
      ...
      <div class="row featurette" id="Upcoming Event">
        <div class="col-md-7 order-md-2">
          ...
          <p><a class="btn btn-secondary" href="events/march-4-2018-owen-howard.php" role="button">View Details &raquo;</a></p>
        </div>
      ...
      <div class="row featurette" id="Upcoming Event">
        <div class="col-md-7 order-md-2">
          <h2 class="featurette-heading">Deirdre Cooper Owens Lecture and Book Signing</h2>
          <p class="lead">Deirdre Cooper Owens discusses race, gender, and the origins of American gynecology.</p>
          <p>Mar 18, 2018  4:40 PM – 6:40 PM</p>
          <p><a class="btn btn-secondary" href="events/march-18-2018-deirdre-cooper-owens.php" role="button">View Details &raquo;</a></p>
        </div>
        <div class="col-md-5 order-md-1">
          <img class="featurette-image img-fluid mx-auto" src="../images/events/deirdre-cooper-owens.png" alt="Deirdre Cooper Owens">
        </div>
      </div>
      ...
      <div class="row featurette" id="Upcoming Event">
        <div class="col-md-7 order-md-2">
          <h2 class="featurette-heading">One Breath Rising: Rubin Gonzalez</h2>
          <p class="lead">Originally from San Juan, Argentina, Ruben composes and plays the guitar with a deeply personal and thought-provoking voice.</p>
          <p>Apr 8, 2018  4:40 PM – 6:40 PM</p>
          <p><a class="btn btn-secondary" href="events/april-8-2018-rubin-gonzalez.php" role="button">View Details &raquo;</a></p>
        </div>
        <div class="col-md-5 order-md-1">
          <img class="featurette-image img-fluid mx-auto" src="../images/events/rubin-gonzalez.jpg" alt="Generic placeholder image">
        </div>
      </div>
