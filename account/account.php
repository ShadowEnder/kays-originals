...
if(isset($_POST['new']) && $_POST['new']==1)
{
  ...
  if ($error != "") {
      ...
      if ($row['email'] == $_POST['email']) {
        ...
        $status = "Account Info Updated Successfully!";
      ...
      } elseif (($row['email'] !== $_POST['email']) && (mysqli_num_rows($result) > 0)) {
...
<p><input class="form-control" type="email" name="email2" placeholder="Confirm Email" required value="<?php echo $row['email2'];?>" /></p>-->
<!--
...
<p><input class="form-control" type="text" name="firstname" placeholder="Enter First Name" required autofocus value="<?php echo $row['firstname'];?>" /></p>
...
<p class="text-center"><a href="changepassword.php" style="color: #4d84f9;">Change Password</a></p>
